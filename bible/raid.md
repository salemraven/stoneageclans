...
**Related:** `bible/hunting.md` (parallel brain + party pattern for AI clans)

---

## Overview

Raiding is an **offensive clan action**: fighters leave their territory, march to an enemy claim, engage defenders, and return home. It uses a **pull-based** model: the ClanBrain sets **raid intent**; NPCs discover it and self-assign via RaidState. No central micromanagement — emergent behavior from stat-driven decisions.
...
- **AI Clan Brain guide:** `bible/ai_clan_brain.md`
- **RTS / Hostile mode:** `bible/rtsguide.md`
- **Combat / Agro:** `bible/AgroGuide.md`
