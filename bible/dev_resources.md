...
**Last updated:** May 2026 · **Guides index:** `bible/README.md` · **Design canon:** `bible.md`
...
- **ClanBrain report (standard 5 min)** — `bash tools/run_clanbrain_report_5min.sh` → `Tests/logs/clanbrain_report_*/clanbrain_report.md`. Spec: `bible/clanbrain_report.md`.
...
| `critical_fixes_implementation_*.plan.md` | *(Legacy.)* `bible/future implementations/CRITICAL_FIXES.md` was removed Apr 2026 — treat matching plans as historical unless revived. |
