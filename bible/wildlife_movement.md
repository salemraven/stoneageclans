...
Player-led hunts use RTS **Peace / Agro / Hunt** and can attack valid combat targets independently (see **`bible/Phase4/raiding_hunting.md`**).
...
Gameplay detail alongside hunt stances: **`bible/Phase4/raiding_hunting.md`** §5.
