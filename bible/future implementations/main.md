...
**Known stale claims in body:** War Horn (**H** is implemented — `bible/rts.md`); ClanBrain on campfire; NPC hunts — see `bible/hunting.md`.
...
- **`bible/game_map.md`**: Chunk streaming, world seed, MP map notes (living implementation doc)
- **`charactermenu.md`**: Character menu specifications
- **`dev_menu.md`**: Developer menu planning
- **`bible/dev_resources.md`**: Cursor plans, dev workflow
...
### Current Focus
- Multiplayer foundation (`NetworkManager`, `GameSync`) and **chunk-streamed** world (`bible/game_map.md`)
- Core systems refinement (combat, tasks, ClanBrain)
- UI/UX polish
