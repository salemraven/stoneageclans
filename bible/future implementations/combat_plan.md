...
**Reference**: See `main.md` for full design documentation and rationale. **Doc refreshed:** April 2026 (implementation status unchanged; see `COMBAT_IMPLEMENTATION_SUMMARY.md`).
