...
**Last updated:** May 2026 · **Hub:** `bible/hunting.md` · **Canon:** `bible.md` §XV-A, §XVIII
...
**Authoritative numbers** (formations, speeds, horn): **`bible/rts.md`** — especially **§4** (geometry) and **§11a** (modes). **Edge cases:** `docs/hunting_system_edge_cases.md`.
...
**Raid-style tip:** For **long marches**, keep **Peace** mode and **FOLLOW** (or **GUARD** if you want a tighter ring at the cost of speed). Switch to **Agro** and **ATTACK** when you’re **close** to contact so the line forms **ahead** — same idea as before the hunt update (`bible/rtsguide.md` §4).
...
- **No target ping:** The arc is **only relative to you** — you **physically** aim the group toward prey (`bible/rts.md` §11a).
...
- **PEACE / AGRO:** **H** still **rallies** nearby same-clan fighters (radius in **`RTS_CONFIG`**) and refreshes follow/context — see **`bible/rts.md`**.
...
- **`bible/Phase4/Raiding_hunting_phase2.md`** — Deeper raid/hunt roadmap (phase 2: doctrine, telemetry, raid/hunt parity, guardrails).
- **`bible/rts.md`** — Full RTS reference including **§11a** (modes).
- **`bible/rtsguide.md`** — Player-facing RTS overview (selection, drag, hostile).
- **`bible/wildlife_movement.md`** — Migratory vs territorial wild NPCs, chunk spawn, **deer flight / fright / debug JSONL**.
- **`bible.md`** — Lore / primitive command tone.

---

*Last updated: May 2026 — Deer fright meter, player proximity fallback, flee burst speed; wild NPC trace / playtest probes (see `bible/wildlife_movement.md`).*
