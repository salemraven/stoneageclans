...
**Warning:** Many rows below are **historical** (Feb 2026). Before implementing, cross-check **`bible.md` §XXI** and code. **Current open work** also lives in `earlygame_roadmap.md` (soc planning workspace) and playtest reports (`bible/clanbrain_report.md`).

**Guide index:** `bible/README.md`
