...
> **Historical phase doc (partially stale).** Prefer **`bible.md` §XXI**, **`bible/main.md`**, **`bible/phase2/STATE_PRIORITIES.md`** for FSM truth.
...
4. See `bible/future implementations/ai_clan_brain.md` for full plan
...
- See `bible/phase2/Task_system.md` for full documentation
...
See `bible/phase2/TEST_STEP1_context_menu.md` for comprehensive test procedures covering:
...
**Documentation:**
- See `bible/phase2/Task_system.md` for complete task system documentation
- See `bible/phase2/phase2cleanup.md` for integration fixes and cleanup plan
- See `bible/phase2/STATE_PRIORITIES.md` for state priority hierarchy
- See `bible/phase2/STATE_BLOCKING_RULES.md` for state blocking rules
- See `bible/phase2/TASK_SYSTEM_REPORT.md` for task system audit and implementation details
...
See `bible/phase2/STATE_PRIORITIES.md` for complete documentation.
...
See `bible/phase2/phase2cleanup.md` for complete cleanup plan and implementation details.
...
- See `bible/phase2/Task_system.md` for complete documentation
