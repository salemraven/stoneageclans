...
**Related docs:** `bible/aboutsoc.md` (systems & loops), `bible/earlygame.md` (design), `bible/gdd.md` (canonical GDD), `bible/multiplayer.md` (browser/net roadmap), `bible/Phase4/not_implemented_systems.md`, `bible/AgroCombatTestIssues.md`
...
|---------|------------|-------|
| Decay for abandoned buildings | `bible/earlygame.md` | last_activity_time, ABANDON_THRESHOLD, DecayManager |
| Pack hut into travois | `bible/earlygame.md` | get_pack_into_travois_result(), hut_recipe - travois_recipe |
| Campfire → land claim upgrade | `bible/earlygame.md` | Progression path |
| TransportJob for clansmen travois | `bible/earlygame.md` | ClanBrain/claim generates when transport needed |
| Hominid classes | `bible/earlygame.md`, `bible/hominids.md` | Homo Sapiens, Neanderthal, Denisovan, Homo Erectus |
| Thirst | GDD | Only hunger in |
| Day/night cycle | `bible/future implementations/daynight.md` | Exposure, torches |
| Wounds & healing | GDD, `bible/Phase4/not_implemented_systems.md` | Medic Hut, auto-path |
| Relics & Shrine | GDD | Clan-wide buffs |
| War Horn (H) | GDD | Herd idle clansmen to player |
| Predators | `bible/future implementations/predator.md` | Wolves, mammoths |
...
The GDD (`bible/gdd.md`) is the canonical design. Current implementation gaps:
...
15. Wounds, Medic Hut
16. War Horn
17. Browser export (see `bible/multiplayer.md` Phase 1)
