...
1. Add a short section to a relevant guide (e.g. `bible/phase2/Task_system.md` or `bible/tasks_guide.md`) that states:
...
**Files to touch:** One of `bible/phase2/Task_system.md`, `bible/tasks_guide.md`, or `bible/main.md` (brief “Systems” subsection).
