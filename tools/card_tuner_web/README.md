...
Browser preview of overlapping `layered_blank_1.tres` plus weapon presets (`club_clansmen_1.tres`, `none_clansmen_1.tres`).

Use the **Weapon** dropdown: **None** for empty-hand idle arms, **Club** for club grip tuning.
...
| Save to repo | Yes (`club` or `none` preset) | Yes |
